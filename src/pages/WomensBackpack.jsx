...
const WomensBackpackPage = () => {
  ...
  return (
    ...
    <img src="/images/backpackw_hero.png" alt="Elegant Laptop Bags" className="hero-image" />
    </div>


      <div className="womensbackpack-container">
        <div className="womensbackpack-filter-bar">
          <div className="womensbackpack-filter-section">
            <span className="womensbackpack-filter-label">Filter:</span>
            <div className="womensbackpack-filter-dropdown">
              <button className="womensbackpack-filter-btn">
                Availability {selectedCount > 0 && `(${selectedCount})`} ▼
              </button>
              <div className="womensbackpack-dropdown-content">
                <div className="womensbackpack-dropdown-header">
                  <span>{selectedCount} selected</span>
                  <button onClick={resetFilters} className="womensbackpack-reset-btn">Reset</button>
                </div>
                <label className="womensbackpack-checkbox-label">
                  <input
                    type="checkbox"
          ...
          <div className="womensbackpack-sort-section">
            <span className="womensbackpack-products-count">{filteredProducts.length} Products</span>
          ...
          {sortedProducts.map(product => (
            <div key={product.id} className="womensbackpack-product-card">
              ...
              <div className="womensbackpack-product-info">
                ...
                {!product.inStock && <p className="womensbackpack-out-of-stock">Out of Stock</p>}
              </div>
            </div>
          ))}
        </div>
