...
const scrollToTop = () => {
  ...
  const products = [
    { id: 1, name: 'Leather Sling Bag', image: '/images/sling1.png', color: 'Dark Brown', date: '2024-01-15', description: 'Elegant leather clutch in classic black. Perfect for evening events with compact storage for essentials.' },
    { id: 2, name: 'Leather Sling Bag', image: '/images/sling2.png', color: 'Olive Brown', date: '2024-02-20', description: 'Sophisticated brown leather clutch with premium finish. Features secure closure and refined styling.' },
    { id: 3, name: 'Leather Sling Bag', image: '/images/sling3.png', color: 'Chestnut Brown', date: '2024-03-10', description: 'Glittering gold evening clutch for special occasions. Combines elegance with compact functionality.' },
    { id: 4, name: 'Leather Sling Bag', image: '/images/sling4.png', color: 'Tan Brown', date: '2024-01-25', description: 'Silver metallic clutch with contemporary design. Perfect for adding sparkle to any formal outfit.' },
    { id: 5, name: 'Leather Sling Bag', image: '/images/sling5.png', color: 'Dark Olive Green', date: '2024-04-05', description: 'Versatile tan crossbody bag with adjustable strap. Features multiple compartments for organized storage.' },
    { id: 6, name: 'Leather Sling Bag', image: '/images/sling8.png', color: 'Rust Brown', date: '2024-02-14', description: 'Dark brown crossbody bag in premium leather. Combines practicality with sophisticated style.' },
    { id: 7, name: 'Mini Leather Satchel Bag', image: '/images/sling9.png', color: 'Light Tan', date: '2024-05-18', description: 'Classic black mini satchel with structured design. Perfect for daily essentials with elegant appeal.' },
    { id: 8, name: 'Mini Leather Satchel Bag', image: '/images/sling10.png', color: 'Dark Brown', date: '2024-03-22', description: 'Brown leather mini satchel with timeless design. Features comfortable strap and secure closure.' },
    { id: 9, name: 'Leather Flap Sling Bag', image: '/images/sling11.png', color: 'Charcoal Grey', date: '2024-06-30', description: 'Elegant tan chain bag with metallic accents. Can be worn as shoulder bag or clutch.' },
    { id: 10, name: 'Leather Flap Sling Bag', image: '/images/sling12.png', color: 'Medium Brown', date: '2024-07-12', description: 'Brown chain bag with premium leather construction. Features detachable chain for versatile styling.' },
    { id: 11, name: 'Leather Shoulder Sling Bag', image: '/images/sling13.png', color: 'Sand Tan', date: '2024-08-05', description: 'Classic black leather shoulder bag. Perfect combination of style and everyday functionality.' },
    { id: 12, name: 'Mini Saddle Crossbody Bag', image: '/images/cross1.png', color: 'Mustard Tan', date: '2024-01-08', description: 'Sophisticated brown shoulder bag with refined details. Features comfortable strap and spacious interior.' },
    { id: 13, name: 'Mini Leather Crossbody Bag', image: '/images/cross2.png', color: 'Light Tan', date: '2024-09-14', description: 'Compact tan wristlet with wrist strap. Ideal for carrying essentials during quick outings.' },
    { id: 14, name: 'Leather Wristlet Clutch', image: '/images/cross3.png', color: 'Dark Olive Green', date: '2024-04-28', description: 'Black leather wristlet with secure zipper. Perfect for cards, phone, and small essentials.' },
