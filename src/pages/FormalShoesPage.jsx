...
const FormalShoesPage = () => {
  ...
  const products = [
    { id: 1, name: 'Penny Loafer', image: '/images/formal1.png', color: 'Black', date: '2024-01-15', description: 'A sleek slip-on penny loafer offering timeless style and everyday comfort.' },
    { id: 2, name: 'Oxford Cap-Toe Leather Shoe', image: '/images/formal2.png', color: ' Tan Brown', date: '2024-02-20', description: 'Classic cap-toe Oxford designed for formal occasions and business attire.' },
    { id: 3, name: 'Oxford Plain-Toe Leather Shoe', image: '/images/formal3.png', color: 'Dark Brown', date: '2024-03-10', description: 'Minimal plain-toe Oxford delivering a clean and sophisticated formal look.' },
    { id: 4, name: 'Oxford Cap-Toe Leather Shoe', image: '/images/formal4.png', color: 'Light Tan', date: '2024-01-25', description: 'A traditional cap-toe Oxford with a warm tan finish for formal styling.' },
    { id: 5, name: 'Derby Plain-Toe Leather Shoe', image: '/images/formal5.png', color: 'Medium Brown', date: '2024-04-05', description: 'Comfortable lace-up Derby ideal for both office wear and formal events.' },
    { id: 6, name: 'Wholecut Leather Shoe', image: '/images/formal6.png', color: 'Cognac Brown', date: '2024-02-14', description: 'Premium wholecut leather shoe made from a single piece of leather for a sleek finish.' },
    { id: 7, name: 'Single Monk Strap Leather Shoe', image: '/images/formal7.png', color: 'Dark Brown', date: '2024-05-18', description: 'Elegant monk strap shoe balancing classic design with modern sophistication.' },
    { id: 8, name: 'Brogue Oxford Leather Shoe', image: '/images/formal8.png', color: 'Black', date: '2024-03-22', description: 'Detailed brogue Oxford combining formal structure with decorative perforations.' },
    { id: 9, name: 'Oxford Plain-Toe Leather Shoe', image: '/images/formal9.png', color: 'Black', date: '2024-06-30', description: 'Sharp plain-toe Oxford designed for professional and formal use.' },
    { id: 10, name: 'Double Monk Strap Leather Shoe', image: '/images/formal10.png', color: 'Tan Brown', date: '2024-07-12', description: 'Stylish double monk strap shoe offering a bold yet elegant formal look.' },
  ...
  return (
    <div className="formalshoes-page">
      ...
      <div className="formalshoes-hero-section">
        <img src="/images/formalbanner.png" alt="Elegant Formal Shoes" className="formalshoes-hero-image" />
      </div>
