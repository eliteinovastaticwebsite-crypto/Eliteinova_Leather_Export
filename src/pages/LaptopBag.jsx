...
const LaptopBagsPage = () => {
  ...
  const products = [
    { id: 1, name: 'Rexo Crunch Leather Laptop Bag', image: '/images/lap1.png', color: 'Brown', date: '2024-01-15', description: 'Premium crunch leather laptop bag with dedicated padded compartment. Features multiple organizational pockets for tech accessories.' },
    { id: 2, name: 'Rexo Crunch Leather Laptop Bag', image: '/images/lap2.png', color: 'Green', date: '2024-02-20', description: 'Eco-friendly green leather laptop bag with sustainable materials. Provides secure protection for laptops up to 15.6 inches.' },
    { id: 3, name: 'Rexo Crunch Leather Laptop Bag', image: '/images/lap3.png', color: 'Black', date: '2024-03-10', description: 'Classic black leather laptop bag with professional design. Features reinforced handles and adjustable shoulder strap.' },
    { id: 4, name: 'Rexo Crunch Leather Laptop Bag', image: '/images/lap4.png', color: 'Tan', date: '2024-01-25', description: 'Sophisticated tan leather laptop bag with spacious interior. Perfect for professionals needing to carry laptops and documents.' },
    { id: 5, name: 'The Philos Leather Laptop Bag', image: '/images/lap5.png', color: 'Black', date: '2024-04-05', description: 'Luxurious Philos leather laptop bag with modern minimalist design. Features intelligent organization and premium zippers.' },
    { id: 6, name: 'The Philos Leather Laptop Bag', image: '/images/lap6.png', color: 'Brown', date: '2024-02-14', description: 'Rich brown Philos leather laptop bag with refined craftsmanship. Provides excellent laptop protection with stylish appearance.' },
    { id: 7, name: 'The Philos Leather Laptop Bag', image: '/images/lap7.png', color: 'Tan', date: '2024-05-18', description: 'Beautiful tan Philos leather laptop bag with elegant finish. Comfortable to carry with ergonomic design features.' },
    { id: 8, name: 'Vintage Leather Travel Laptop Bag', image: '/images/lap8.png', color: 'Brown', date: '2024-03-22', description: 'Vintage-inspired travel laptop bag with practical functionality. Large capacity perfect for business trips and daily commute.' },
    { id: 9, name: 'Vintage Leather Travel Laptop Bag', image: '/images/lap9.png', color: 'Black', date: '2024-06-30', description: 'Classic travel laptop bag in sleek black leather. Features reinforced padding and multiple compartments for organization.' },
    { id: 10, name: 'Urban Leather Laptop Bag', image: '/images/lap10.png', color: 'Black', date: '2024-07-12', description: 'Modern urban laptop bag with contemporary design. Perfect for tech professionals with secure laptop compartment.' },
    { id: 11, name: 'Urban Leather Laptop Bag', image: '/images/lap11.png', color: 'Tan', date: '2024-08-05', description: 'Contemporary tan urban leather laptop bag. Combines functionality with fashion-forward design elements.' },
    { id: 12, name: 'Classic Leather Laptop Bag', image: '/images/lap12.png', color: 'Dark Brown', date: '2024-01-08', description: 'Timeless dark brown leather laptop bag with traditional design. Features durable construction and professional appearance.' },
