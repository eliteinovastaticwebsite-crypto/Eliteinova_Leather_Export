...
const ShoesPage = () => {
  ...
  const products = [
    ...
    { id: 2, name: 'Classic Leather Boot', image: '/images/formal1.png', color: 'Black', date: '2024-02-20', description: 'Sophisticated black leather boots with timeless design. Perfect for both formal occasions and casual outings.' },
    { id: 3, name: 'Oxford Formal Shoes', image: '/images/formal2.png', color: 'Brown', date: '2024-03-10', description: 'Elegant Oxford shoes crafted from premium leather. Features classic brogue detailing and comfortable fit.' },
    { id: 4, name: 'Oxford Formal Shoes', image: '/images/formal3.png', color: 'Black', date: '2024-01-25', description: 'Classic black Oxford shoes with polished finish. Perfect for business meetings and formal events.' },
    { id: 5, name: 'Derby Formal Shoes', image: '/images/formal4.png', color: 'Tan', date: '2024-04-05', description: 'Versatile Derby shoes in rich tan leather. Features open lacing system for adjustable comfort.' },
    { id: 6, name: 'Derby Formal Shoes', image: '/images/formal5.png', color: 'Dark Brown', date: '2024-02-14', description: 'Dark brown Derby shoes with sophisticated appeal. Durable construction with excellent arch support.' },
    { id: 7, name: 'Chelsea Boot', image: '/images/formal6.png', color: 'Black', date: '2024-05-18', description: 'Classic Chelsea boots in sleek black leather. Features elastic side panels for easy wear and superior comfort.' },
    { id: 8, name: 'Chelsea Boot', image: '/images/formal7.png', color: 'Brown', date: '2024-03-22', description: 'Brown Chelsea boots with premium leather finish. Versatile design suitable for various occasions.' },
    { id: 9, name: 'Casual Loafers', image: '/images/formal8.png', color: 'Tan', date: '2024-06-30', description: 'Comfortable tan loafers with slip-on design. Perfect for casual outings and relaxed settings.' },
    { id: 10, name: 'Casual Loafers', image: '/images/formal9.png', color: 'Brown', date: '2024-07-12', description: 'Classic brown loafers with sophisticated styling. Features padded footbed for all-day comfort.' },
    { id: 11, name: 'Monk Strap Shoes', image: '/images/formal10.png', color: 'Black', date: '2024-08-05', description: 'Elegant monk strap shoes in black leather. Features double buckle closure for secure fit.' },
    { id: 12, name: 'Monk Strap Shoes', image: '/images/formal11.png', color: 'Brown', date: '2024-01-08', description: 'Sophisticated brown monk strap shoes. Combines traditional design with modern comfort features.' },
    { id: 13, name: 'Monk Strap Shoes', image: '/images/formal12.png', color: 'Brown', date: '2024-01-08', description: 'Sophisticated brown monk strap shoes. Combines traditional design with modern comfort features.' },
    { id: 14, name: 'Monk Strap Shoes', image: '/images/formal13.png', color: 'Brown', date: '2024-01-08', description: 'Sophisticated brown monk strap shoes. Combines traditional design with modern comfort features.' },
   /* { id: 15, name: 'Oxford Formal Shoes', image: '/images/casual.png', color: 'Black', date: '2024-01-25', description: 'Classic black Oxford shoes with polished finish. Perfect for business meetings and formal events.' },*/
    { id: 16, name: 'Derby Formal Shoes', image: '/images/casual2.png', color: 'Tan', date: '2024-04-05', description: 'Versatile Derby shoes in rich tan leather. Features open lacing system for adjustable comfort.' },
