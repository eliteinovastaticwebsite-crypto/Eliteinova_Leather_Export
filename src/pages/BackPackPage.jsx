...
const BackpackPage = () => {
  ...
  const products = [
    ...
    { id: 9, name: 'Vintage Leather Travel Backpack', image: '/api/placeholder/300/300', color: 'Black', inStock: true, date: '2024-06-30' },
    { id: 10, name: 'Urban Leather Backpack', image: '/api/placeholder/300/300', color: 'Black', inStock: true, date: '2024-07-12' },
    { id: 11, name: 'Urban Leather Backpack', image: '/api/placeholder/300/300', color: 'Tan', inStock: false, date: '2024-08-05' },
    { id: 12, name: 'Classic Leather Backpack', image: '/api/placeholder/300/300', color: 'Dark Brown', inStock: true, date: '2024-01-08' },
    { id: 13, name: 'Classic Leather Backpack', image: '/api/placeholder/300/300', color: 'Brown', inStock: true, date: '2024-09-14' },
    { id: 14, name: 'Topper Stylish Leather Travel Backpack', image: '/api/placeholder/300/300', color: 'Brown', inStock: true, date: '2024-04-28' },
    { id: 15, name: 'Topper Stylish Leather Travel Backpack', image: '/api/placeholder/300/300', color: 'Black', inStock: false, date: '2024-10-20' },
    { id: 16, name: 'Leather Laptop Backpack', image: '/api/placeholder/300/300', color: 'Black', inStock: true, date: '2024-05-07' },
    { id: 17, name: 'Leather Laptop Backpack', image: '/api/placeholder/300/300', color: 'Brown', inStock: true, date: '2024-11-11' },
    { id: 18, name: 'Urban Leather Rucksack', image: '/api/placeholder/300/300', color: 'Black', inStock: true, date: '2024-06-17' },
    { id: 19, name: 'Urban Leather Rucksack', image: '/api/placeholder/300/300', color: 'Dark Brown', inStock: true, date: '2024-12-01' },
    { id: 20, name: 'Premium Leather Travel Backpack', image: '/api/placeholder/300/300', color: 'Tan', inStock: true, date: '2024-07-25' }
  ];
  ...
  return (
    <div className="backpack-page">
      <div className="backpack-breadcrumb">
      ...
      <div className="backpack-container">
        <div className="backpack-filter-bar">
          <div className="backpack-filter-section">
            <span className="backpack-filter-label">Filter:</span>
            <div className="backpack-filter-dropdown">
              <button className="backpack-filter-btn">
                Availability {selectedCount > 0 && `(${selectedCount})`} ▼
              </button>
              <div className="backpack-dropdown-content">
                <div className="backpack-dropdown-header">
                  <span>{selectedCount} selected</span>
                  <button onClick={resetFilters} className="backpack-reset-btn">Reset</button>
                </div>
                <label className="backpack-checkbox-label">
                  <input
                    type="checkbox"
          ...
          <div className="backpack-sort-section">
            <span className="backpack-products-count">{filteredProducts.length} Products</span>
            <div className="backpack-sort-dropdown">
              <label>Sort By:</label>
        ...
        <div className="backpack-products-grid">
          {sortedProducts.map(product => (
            <div key={product.id} className="backpack-product-card">
              <div className="backpack-product-image">
                <img src={product.image} alt={product.name} />
              </div>
              <div className="backpack-product-info">
                <h3 className="backpack-product-name">{product.name}</h3>
                <p className="backpack-product-color">{product.color}</p>
                {!product.inStock && <p className="backpack-out-of-stock">Out of Stock</p>}
              </div>
            </div>
          ))}
        </div>
      ...
      <a href="https://wa.me/9876543210" className="backpack-whatsapp-btn" target="_blank" rel="noopener noreferrer">
