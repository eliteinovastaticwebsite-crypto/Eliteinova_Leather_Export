...
const CasualShoesPage = () => {
  ...
  const products = [
    { id: 1, name: 'Casual Slip-On Loafer', image: '/images/casual3.png', color: 'Charcoal Grey', date: '2024-01-15', description: 'Easy slip-on loafer offering comfort and everyday versatility.' },
    { id: 2, name: 'Casual Moccasin Shoe', image: '/images/casual4.png', color: 'Brown', date: '2024-02-20', description: 'Soft leather moccasin providing flexibility and all-day comfort.' },
    { id: 3, name: 'Casual Moccasin Shoe', image: '/images/casual5.png', color: 'Beige', date: '2024-03-10', description: 'Lightweight moccasin perfect for casual outings and travel wear.' },
    { id: 4, name: 'Casual Loafers', image: '/images/casual6.png', color: 'Black', date: '2024-01-25', description: 'Breathable casual loafer designed for relaxed daily use.' },
    { id: 5, name: 'Casual Moccasin Shoe', image: '/images/casual7.png', color: 'Dark Brown', date: '2024-04-05', description: 'Classic moc-toe design offering durability and comfort.' },
    { id: 6, name: 'Casual Moccasin Shoe', image: '/images/casual8.png', color: 'Olive Green', date: '2024-02-14', description: 'Stylish casual moccasin ideal for weekend and travel wear.' },
    { id: 7, name: 'Casual Moccasin Shoe', image: '/images/casual9.png', color: 'Tan Brown', date: '2024-05-18', description: 'Comfortable slip-on moccasin with a soft leather finish.' },
    { id: 8, name: 'Casual Moccasin Shoe', image: '/images/casual10.png', color: 'Dark Brown', date: '2024-03-22', description: 'Rugged moccasin built for everyday comfort and durability.' },
    { id: 9, name: 'Casual Moccasin Shoe', image: '/images/casual11.png', color: 'Light Tan', date: '2024-06-30', description: 'Lightweight moccasin shoe suited for relaxed and casual styling.' },
