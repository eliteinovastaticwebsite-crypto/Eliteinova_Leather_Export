...
const BriefcasesPage = () => {
  ...
  const products = [
    { id: 1, name: 'Rexo Crunch Leather Handbag', image: '/images/red_handba.png', color: 'Brown', inStock: true, date: '2024-01-15' },
    { id: 2, name: 'Rexo Crunch Leather Handbag', image: '/images/H.png', color: 'Green', inStock: false, date: '2024-02-20' },
    { id: 3, name: 'Rexo Crunch Leather Handbag', image: '/images/H.png', color: 'Black', inStock: true, date: '2024-03-10' },
    { id: 4, name: 'Rexo Crunch Leather Handbag', image: '/images/H.png', color: 'Tan', inStock: true, date: '2024-01-25' },
    { id: 5, name: 'The Philos Leather Handbag', image: '/images/H.png', color: 'Black', inStock: true, date: '2024-04-05' },
    { id: 6, name: 'The Philos Leather Handbag', image: '/images/H.png', color: 'Brown', inStock: false, date: '2024-02-14' },
    { id: 7, name: 'The Philos Leather Handbag', image: '/images/H.png', color: 'Tan', inStock: true, date: '2024-05-18' },
    { id: 8, name: 'Vintage Leather Travel Handbag', image: '/images/H.png', color: 'Brown', inStock: true, date: '2024-03-22' },
    { id: 9, name: 'Vintage Leather Travel Handbag', image: '/images/H.png', color: 'Black', inStock: true, date: '2024-06-30' },
    { id: 10, name: 'Urban Leather Handbag', image: '/images/H.png', color: 'Black', inStock: true, date: '2024-07-12' },
    { id: 11, name: 'Urban Leather Handbag', image: '/images/H.png', color: 'Tan', inStock: false, date: '2024-08-05' },
    { id: 12, name: 'Classic Leather Handbag', image: '/images/H.png', color: 'Dark Brown', inStock: true, date: '2024-01-08' },
    { id: 13, name: 'Classic Leather Handbag', image: '/images/H.png', color: 'Brown', inStock: true, date: '2024-09-14' },
    { id: 14, name: 'Topper Stylish Leather Travel Handbag', image: '/images/H.png', color: 'Brown', inStock: true, date: '2024-04-28' },
    { id: 15, name: 'Topper Stylish Leather Travel Handbag', image: '/images/H.png', color: 'Black', inStock: false, date: '2024-10-20' },
