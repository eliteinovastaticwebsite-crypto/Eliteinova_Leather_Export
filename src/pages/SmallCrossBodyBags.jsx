...
const SmallCrossBodyBagsPage = () => {
  ...
  const products = [
   ...
   /* { id: 4, name: 'Rexo Crunch Leather Small Cross Body Bag', image: '/images/C3.png', color: 'Tan', inStock: true, date: '2024-01-25' },
    ...
    { id: 8, name: 'Vintage Leather Travel Small Cross Body Bag', image: '/images/C7.png', color: 'Brown', inStock: true, date: '2024-03-22' },
    { id: 9, name: 'Vintage Leather Travel Small Cross Body Bag', image: '/images/C8.png', color: 'Black', inStock: true, date: '2024-06-30' },
    { id: 10, name: 'Urban Leather Small Cross Body Bag', image: '/images/C9.png', color: 'Black', inStock: true, date: '2024-07-12' },
    { id: 11, name: 'Urban Leather Small Cross Body Bag', image: '/images/C10.png', color: 'Tan', inStock: false, date: '2024-08-05' },
    { id: 12, name: 'Classic Leather Small Cross Body Bag', image: '/images/C11.png', color: 'Dark Brown', inStock: true, date: '2024-01-08' },
    { id: 13, name: 'Classic Leather Small Cross Body Bag', image: '/images/C12.png', color: 'Brown', inStock: true, date: '2024-09-14' },
    { id: 14, name: 'Topper Stylish Leather Travel Small Cross Body Bag', image: '/images/C13.png', color: 'Brown', inStock: true, date: '2024-04-28' },
    { id: 15, name: 'Topper Stylish Leather Travel Small Cross Body Bag', image: '/images/C14.png', color: 'Black', inStock: false, date: '2024-10-20' },
    { id: 16, name: 'Leather Shoulder Small Cross Body Bag', image: '/api/placeholder/300/300', color: 'Black', inStock: true, date: '2024-05-07' },
  ...
  return (
    <div className="crossbodybags-page">
      <div className="crossbodybags-breadcrumb">
        <a href="/">Home</a> / <span>Small Cross Body Bags</span>
      </div>
      ...
      <div className="crossbodybags-container">
        <div className="crossbodybags-filter-bar">
          <div className="crossbodybags-filter-section">
            <span className="crossbodybags-filter-label">Filter:</span>
            <div className="crossbodybags-filter-dropdown">
              <button className="crossbodybags-filter-btn">
                Availability {selectedCount > 0 && `(${selectedCount})`} ▼
              </button>
              <div className="crossbodybags-dropdown-content">
                <div className="crossbodybags-dropdown-header">
                  <span>{selectedCount} selected</span>
                  <button onClick={resetFilters} className="crossbodybags-reset-btn">Reset</button>
                </div>
                <label className="crossbodybags-checkbox-label">
                  <input
                    type="checkbox"
          ...
          <div className="crossbodybags-sort-section">
            <span className="crossbodybags-products-count">{filteredProducts.length} Products</span>
          ...
          {sortedProducts.map(product => (
            <div key={product.id} className="crossbodybags-product-card">
              ...
              <div className="crossbodybags-product-info">
                ...
                {!product.inStock && <p className="crossbodybags-out-of-stock">Out of Stock</p>}
              </div>
            </div>
          ))}
        </div>
